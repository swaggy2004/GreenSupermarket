...
public class PaymentServices {
    ...
    redirectUrls.setCancelUrl("http://localhost:8080/GreenSupermarket/UserDashboard.jsp");
    redirectUrls.setReturnUrl("http://localhost:8080/GreenSupermarket/review_payment");

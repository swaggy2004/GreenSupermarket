            ...
            <div class="col-md-12">
                ...
                <div class="card mb-3" style="max-width: 1280px;border:none;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-11">
                            <div class="card-body">
                                <h6 class="card-title">Our delivery man will attempt to deliver your order in the next hour</h6>
                                <p class="card-text"><small class="text-body-secondary">13 December, 2023 at 10:05 AM</small></p>
                            </div>
                        </div>
                    </div>
                </div>

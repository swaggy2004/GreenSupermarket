  	 ...
  	 <div class="container">
  	 	<div class="row">
  	 		...
  	 		<div class="footer-col">
  	 			...
  	 			<ul>
  	 				<li><a href="ManagerDashboard.jsp">Manager Dashboard</a></li>
  	 				<li><a href="OrderManagement.jsp">Orders Management</a></li>
  	 		...
  	 		<div class="footer-col">
  	 			<h4>Admin Control</h4>
  	 			<ul>
  	 				<li><a href="AdminProduct.jsp">Product Edit</a></li>
  	 				<li><a href="AdminAccount.jsp">Account Edit</a></li>

      ...
      <div class="row mx-auto gap-5">
        ...
        >
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3 col-12">
              <label for="promotionName" class="form-label"><h5>Promotion Name</h5></label>
          ...
          <div class="row mb-4">
            <div class="col col-md-8 mb-3 col-12">
              ...
              >
              <textarea name="appliedProducts" id="appliedProducts" class="form-control" rows="4"></textarea>
            </div>
          </div>
          ...
          <div class="row mb-3">
            <div class="col col-md-4 mb-3 col-12">
                ...
                >
                <select name="appliedCategories" id="appliedCategories" class="form-select">
          ...
          <div class="row mb-3">
            <div class="col col-md-4 mb-3 col-12">
                <label for="promotionStatus" class="form-label"><h5>Status</h5></label>
                <input type="text" name="promotionStatus" id="promotionStatus" class="form-control">
            </div>
          </div>

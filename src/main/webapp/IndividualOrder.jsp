...
<div style="display: flex; justify-content: center; align-items: center;  margin-top: 1rem; margin-bottom: 3rem;" >
    ...
    <form action="" method="">
        <div class="btn-group" role="group" aria-label="Outlined Checkbox Buttons" style="min-width: 520px">
            ...
            <input type="checkbox" class="btn-check" name="options-outlined-2" id="success-outlined-2" autocomplete="off">
            ...
            <input type="checkbox" class="btn-check" name="options-outlined-3" id="success-outlined-3" autocomplete="off">

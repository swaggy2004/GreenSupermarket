...
<head>
    ...
    <link rel="stylesheet" href="password-success.css">
</head>
<body>
       <!--Navbar-->
    ...
    <div class="full-screen-background d-flex justify-content-center align-items-center">
        <div class="rectangle"> 
            <div class="error-section" >
                ...
                <p class="error-text1 ">Password updated Succesfully!</p>
                <div class="buttons justify-content-center">
                    <a href="UserDashboard.jsp"><button type="button" class="btn home-button mx-6">

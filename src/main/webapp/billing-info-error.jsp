...
<head>
    ...
    <link rel="stylesheet" href="billing-info-error.css">
</head>
<body>
    <!--Nav bar-->
    ...
    <div class="full-screen-background d-flex justify-content-center align-items-center">
        <div class="rectangle"> 
            <div class="error-section" >
                ...
                <p class="error-text1 ">Invalid billing info!</p>
                <p class="error-text2">Check if your billing info is correct and add again</p>

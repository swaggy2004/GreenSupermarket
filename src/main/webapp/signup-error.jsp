    ...
    <div class="full-screen-background d-flex justify-content-center align-items-center">
        <div class="rectangle"> 
            <div class="error-section" >
                ...
                <p class="error-text1 ">Unexpected error occured!</p>
                <p class="error-text2">Oops, error occurred when sigining up. try signing up again</p>
                <div class="buttons justify-content-center">
                    ...
                    <button type="button" class="btn try-button mx-6">
                        <b>Try again</b>
                    </button>
                </div>
            </div>
